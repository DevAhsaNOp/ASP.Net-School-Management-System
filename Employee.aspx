    ...
    <form id="form2" runat="server">
        <nav class="Lnavbar">
            <ul class="Lnavbar-nav">
                ...
                <li class="Lnav-item">
                    <a href="#" class="Lnav-link ">
                        <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="chalkboard"
                            class="svg-inline--fa fa-chalkboard fa-w-20" role="img" xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 640 512">
                            <path fill="currentColor"
                        ...
                        <div class="gvWidthHight">
                            <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" Height="200px" Width="100%" AutoGenerateColumns="False">
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Price" HeaderText="ROLE">
                                        <HeaderStyle Font-Size="Large" />
                                        <ItemStyle Width="15%" Font-Size="Medium" />
                                    </asp:BoundField>
                                    <asp:TemplateField HeaderText="OPTION" HeaderStyle-CssClass="padH">
                                        <ItemTemplate>
                                            <asp:Button Text="Edit" runat="server" PostBackUrl="~/EditEmployee.aspx" BackColor="#17A2B8" BorderStyle="None" Height="30px" Width="100px" CssClass="mar"
                                    ...
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <asp:Button Text="View" runat="server" BackColor="#007BFF" PostBackUrl="~/ViewEmployee.aspx" BorderStyle="None" Height="30px" Width="100px" CssClass="mar"
                                                Font-Names="Lucida Sans" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
